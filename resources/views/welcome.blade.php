...
{{--                                <h6 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Author</h6>--}}
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap truncate dark:text-white">Mamuka</th>
